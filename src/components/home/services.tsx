...
export const Services = () => {
  ...
  return (
    <section
      className="w-[100vw] lg:h-screen h-fit relative space-y-4"
      ref={component}
    >
      <div className="flex lg:flex-row flex-col lg:px-12 px-5 items-center h-[75%] w-full gap-8">
        <div className="bg-black h-full w-[35%] flex items-center justify-center">
          <h1 className="lg:leading-[80px] leading-none header top-[100px]">
            Our
            <br />
            Services.
          </h1>
        ...
        <div
          className="flex md:flex-row flex-col items-center overflow-x-scroll gap-10 lg:w-[65%] h-full scroll-smooth"
          ref={slider}
        >
      ...
      <div className="space-x-8 w-full hidden items-center justify-center md:flex">
        <button
          className="border-[1px] border-white text-white hover:border-green-500 hover:bg-green-500 hover:text-black p-[10px] w-fit rounded-lg"
          onClick={prev}
        >
          <Icon.HiArrowLeft />
        </button>
...
export const ServiceCard = ({ id, title, desc }: ServiceCardProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.span className="mt-6 block" variants={textVariants}>
        <p className="text-sm">{desc}</p>
      </motion.span>

      <a
        className="lg:hidden block underline font-extralight pointer-events-auto"
        href="/about"
      >
        see more
      </a>
