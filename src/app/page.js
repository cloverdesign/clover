...
export default function Home() {
  return (
    <main className="lg:space-y-[200px] space-y-[10px]">
      ...
      <section className="hero relative w-[100vw] flex flex-col items-center overflow-x-hidden justify-center space-y-8" id="home">
        ...
        <hr className='w-3/5 absolute bottom-0' />
      </section>

      <section id="#about" className="flex flex-col w-[100vw] items-center justify-center space-y-8">
        <h2 className="lg:w-3/5 text-center">A diverse design agency passionate about creating digital experiences.</h2>
        <div className="flex items-center gap-4">
          who we are.
          <Button icon={<Icon.HiArrowRight />} iconOnly />
        </div>
      </section>
