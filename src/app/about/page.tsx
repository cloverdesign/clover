...
export const metadata: Metadata = {
  title: "About",
  description:
    "Clover is a diverse design studio crafting global identities for African brands. Meet the team behind the work.",
};
      ...
      <section className="font-thin flex flex-col lg:flex-row border-[0.8px] border-grey rounded-xl p-10 gap-10">
        ...
        <div className="lg:w-2/3 border-t-[0.8px] lg:border-l-[0.8px] lg:border-t-0 py-10 lg:px-10 border-grey">
          ...
          <p className="mb-10">
            ...
            they don&apos;t. At Clover we&apos;ve made it our duty to be
            responsible for the identities of African brands who want to step
            outside the shores of the Sahara and become truly global brands. We
            believe in creating brands that are strong enough to connect with
            audiences, provide real experiences, and most importantly compete on
            a global stage.{" "}
          </p>
...
const Picture = ({ img, hoverImg, classNames }: PictureProps) => {
  return (
    <div className="group">
      {img !== "" ? (
        <>
